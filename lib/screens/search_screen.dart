                        ...
                        Row(
                          children: [
                            Expanded(
                              flex: 6,
                              child:
                                  BlocBuilder<SearchNameBloc, SearchNameState>(
                                      builder: (context, state) {
                                return Container(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          onChanged: (value) {
                                            if (value.isNotEmpty) {
                                              BlocProvider.of<SearchNameBloc>(
                                                      context)
                                                  .add(SearchTextNameChanged(
                                                      value));
                                            }
                                          },
                                              ...
                                              builder: (context) =>
                                                  MultiBlocProvider(
                                                    ...
                                                    BlocProvider.value(
                                                      ...
                                                      child: CottageScreen(state
                                                          .cottage[index])),
                                            ),
                                          ),
                                      child:
                                          CottageWidget(state.cottage[index]));
                                },
                              )
                            : Column(
                                children: [
